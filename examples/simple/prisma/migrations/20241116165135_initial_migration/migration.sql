...
CREATE TABLE "UserLast" (
    ...
    CONSTRAINT "UserLast_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "ExtraModal" (
    ...
    CONSTRAINT "ExtraModal_pkey" PRIMARY KEY ("id")
);
...
-- CreateTable
CREATE TABLE "snake_in_db" (
    "id" SERIAL NOT NULL,
    "title" TEXT NOT NULL,

    CONSTRAINT "snake_in_db_pkey" PRIMARY KEY ("id")
);

-- CreateTable
CREATE TABLE "kebab-in-db" (
    "id" SERIAL NOT NULL,
    "title" TEXT NOT NULL,

    CONSTRAINT "kebab-in-db_pkey" PRIMARY KEY ("id")
);
